      ...
      <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavId">
              ...
              <ul class="navbar-nav mt-2 mt-lg-0">
                  @auth
                      {{-- ici quand l'utilisateur est connecté --}}
                  @endauth
                @guest
                {{-- ici des choses a affichier quand l'utilisateur n'est pas connecte --}}
                ...
                @else 
                {{-- b4-dropdown-default pour generer le dropdown--}}
      ...
      <footer>
          <div class="container-fluid bg-dark pt-4 pb-4">
              <div class="text-center text-light">
                  © OpenShop 2021 | Tous droit reservés.
              </div>
          </div>
      </footer>
    <!-- Optional JavaScript -->
